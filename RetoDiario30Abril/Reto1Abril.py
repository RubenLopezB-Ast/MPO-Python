...
Todos los números decimales por debajo de ,5 se redondean a la baja. Los que tengan decimales desde ,5 a superior, se
redondean al alza.
...
nota = float(input("Introduce tu nota real y exacta con dos decimales: "))

if (nota - int(nota) >= 0.5):
    print(f"Tu nota se te queda en {int((nota)+1)}")
else:
    print(f"Tu nota se te queda en {int(nota)}")